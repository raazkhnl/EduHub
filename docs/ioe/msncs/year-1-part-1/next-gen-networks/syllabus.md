---
title: 'Syllabus — Next Generation Network Technologies'
sidebar_label: 'Syllabus'
sidebar_position: 1
description: 'Official syllabus for Next Generation Network Technologies (ENCTNS501).'
slug: /ioe/msncs/year-1-part-1/next-gen-networks/syllabus
...
2.5 IPv6 address auto-generation, SLAAC
...
3.7 Unicast Routing in IPv6, RIP and OSPF
...
4.4 SDN APIs (North, South, East and West bound)
4.5 Data and Control Plane overview (NOX, POX, Beacon, FloodLight...)
4.6 SDN in the Telecom/ISP Domain
4.7 SDN Programming (P4, Frenetic)
...
5.5 IoT vision, paradigm, technologies: RFID, WSN
5.6 IoT networking challenges
5.7 Edge computing for IoT applications
5.8 Overview of Industrial IoT
...
6.4 Introduction to Named Data Networking (NDN)
6.5 Introduction to Intent Based Networking (IBN)
6.6 Introduction to Quantum Networking (QNet)
6.7 Research trends on latest networking
